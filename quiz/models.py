...
class School_register(models.Model):
    ...
    def __str__(self):
        return str(self.name)+" "+str(self.school_name)
...
class Progress(models.Model):
    ...
    """
    user = models.OneToOneField(settings.AUTH_USER_MODEL, verbose_name=_("Student"), on_delete=models.CASCADE)
